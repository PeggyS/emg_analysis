...
if cocon_flag == true
	...
	line(app.UIAxes_cci, app.emg_data.time, app.emg_data.linear_envelope(bicep_ind,:), ...
		'Tag', 'line_cci_bicep', 'Color', [0 0 0.9], 'LineWidth', 1)
	line(app.UIAxes_cci, app.emg_data.time, app.emg_data.linear_envelope(tricep_ind,:), ...
